...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    try {
      // Menghasilkan order ID secara otomatis
      ...
      // Menambahkan order ke koleksi "orders" di Firestore
      const result = await addDoc(collection(fireDB, "orders"), orderInfo);
      console.log(result); // Output informasi hasil penambahan dokumen
      ...
      toast.error("Gagal menempatkan pesanan", {
        position: "top-center",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
