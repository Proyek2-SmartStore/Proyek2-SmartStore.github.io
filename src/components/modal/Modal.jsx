...
export default function Modal({ name, address, phoneNumber, setName, setAddress, setPhoneNumber, buyNow, closeModal }) {
    ...
    useEffect(() => {
      ...
      }, [isOpen, setName, setAddress, setPhoneNumber]);
        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full  bg-yellow-600 py-2 text-center rounded-lg text-white font-bold"
                >
                    Buy Now
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={()=>{buyNow(); closeModal();}} type="button" className="focus:outline-none w-full text-white bg-yellow-600 hover:bg-yellow-800  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
